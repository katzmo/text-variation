...
export const COL_TEXTS = {
  WEB: [
    ...
    'and gods spirit was hovering over the surface of the waters',
    'god said let there be light and there was light',
    'god saw the light and saw that it was good and god divided the light from the darkness',
  ...
  BBE: [
    ...
    'the earth was without form and empty and darkness was over the deep',
    'and the spirit of god was moving over the face of the waters',
    'and god said let there be light and there was light',
    'and god saw the light was good and a division was made by god between the light and the dark',
    'and god gave the light the name of day and the dark he named night',
    'and there was evening and there was morning the first day',
    'and god said let there be a division of the waters',
  ],
  DR: [
  ...
  GNV: [
    'in the beginning god created the heaven and the earth',
    'and the earth was without forme and void and darkenes was vpon the depe',
    'and the spirite of god moued vpon the waters',
    'and god said let there be light and there was light',
    'and god saw the light that it was good and god separated the light from the darkenes',
    'and god called the light day and the darkenes night',
    'so the euening and the morning were the first day',
    'againe god said let there be a firmament in the middes of the waters',
  ],
  WYC: [
    'in the bigynnyng god made of nouyt heuene and erthe',
    'forsothe the erthe was idel and voide and derknessis weren on the face of depthe',
    'and the spirit of the lord was borun on the watris',
    'and god seide be maad liyt and liyt was maad',
    'and god seiy the liyt that it was good and he departide the liyt fro derknessis',
    'and he clepide the liyt dai and the derknessis nyyt',
    'and the euentid and morwetid was maad o dai',
    'and god seide be maad a firmament in the myddis of watris',
  ],
}
...
export const WITNESSES = [
  {
    ...
    source: 'Masoretic Text, Septuagint',
  },
  {
    id: 'ASV',
  ...
  {
    id: 'DRC',
    name: 'Douay-Rheims Challoner Bible',
    year: 1750,
    origin: [51.5, -0.1],
    affiliation: 'Catholic',
    source: 'Latin Vulgate',
  ...
  {
    id: 'SLT',
    name: 'Smith Literal Translation',
    year: 1876,
    origin: [39.5, -98.4],
    affiliation: 'Protestant',
    source: 'Masoretic Text',
  ...
  },
  {
    ...
    origin: [51.5, -0.1],
    affiliation: 'Protestant',
    source: 'Hebrew, Greek, Latin Vulgate',
  },
  {
    id: 'AVV',
